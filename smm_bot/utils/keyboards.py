...
def main_menu_kb(official_url: str = "", orders_url: str = "") -> InlineKeyboardMarkup:
    """القائمة الرئيسية — أزرار القنوات روابط مباشرة."""
    # زر القناة الرسمية: رابط مباشر لو موجود، وإلا callback
    if official_url:
...
def balance_kb(bep20: bool, trc20: bool, vodafone: bool = True,
    ...
    # ── صف 5: فاتورة ويب ──
    rows.append([InlineKeyboardButton("🧾 إنشاء فاتورة دفع", callback_data="create_invoice")])
