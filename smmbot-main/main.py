...
from handlers.user_menu import (
    ...
    my_api_key_callback, api_key_regen_callback,
)
...
from handlers.admin.panel import (
    ...
    adm_set_support_callback, adm_set_instructions_callback, adm_set_website_url_callback,
...
def register_handlers(app: Application):
    ...
    app.add_handler(CallbackQueryHandler(my_api_key_callback,       pattern="^my_api_key$"))
    app.add_handler(CallbackQueryHandler(api_key_regen_callback,    pattern="^api_key_regen$"))
    ...
    app.add_handler(CallbackQueryHandler(adm_set_website_url_callback,    pattern="^adm_set_website_url$"))
